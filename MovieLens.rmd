...
In the next table are indicated the **RMSEs** obtained on every algorithm being **matrix factorization** __(best performance)__ the one that generated a **`r round(min(RMSE.results$RMSE),5)`** that is below the proposed target.
...
[pdf_file]: https://github.com/HugoAquinoNavarrete/MovieLens/MovieLens.pdf
[rmd_file]: https://github.com/HugoAquinoNavarrete/MovieLens/MovieLens.rmd
[r_file]: https://github.com/HugoAquinoNavarrete/MovieLens/MovieLens.r
